...
def start():
        ...
        if line=='':
            ...
            win = tk.Tk()
            win.title("Результаы ОГЭ")
            win.geometry("640x480")
            out = tk.Label(win, text='Правельный ответ '+ str(score)+' вопросов.',font='Calibri 14')
            out.pack()
            proc= tk.Label(win, text='Процент правильных ответов =  '+ str(int((score/allq)*100))+' %', font='Calibri 14')
            proc.pack()
...
greet = tk.Label(window, text="ОГЭ по Истории" ,font='Calibri 14')
greet.pack()
